...
<div class="container-fluid">    
    <div class="row">
        <div class="col-md-12">
			...
			<div id="tablearea">
			 <table class="table table-bordered table-inverse single-border highlight" style="width:100%"  height="129" cellpadding="2" cellspacing="1">
			  <tr>
			  ...
			  ?>
					<tr>
						...
						<td class="style7"><div align="center" class=" style12"><?php echo number_format($row['QTY'], 0); ?></div></td>
						 <td class="style7"><div align="center" class=" style12"><?php echo number_format($row['STORE_COPY'], 0); ?></div></td>
...
echo $count;
			  ?>
					...
					<?php 
						...
						echo '<td></td>
							<th style="border:1px solid black;">Total Program</th><td></td><td>'.$total.'</td>

							<td>'.$t_st_cpy.'</td>
							<td>'.$t_p_cost.'</td>
							<td>'.$d_cost.'</td>
							<td>'.$t_cost.'</td><td colspan="1000"></td>';
						echo '</tr>';
