...
if (isset($_POST['username'])) {
  ...
  $LoginRS__query=sprintf("SELECT USERNAME,CLIENT_CODE, PASSWORD FROM ON_LOGIN1 WHERE USERNAME='%s' AND CLIENT_CODE='%s' AND PASSWORD='%s'",
    get_magic_quotes_gpc() ? $loginUsername : addslashes($loginUsername), get_magic_quotes_gpc() ? $loginStorename : addslashes($loginStorename), get_magic_quotes_gpc() ? $password : addslashes($password)); 
        ...
        <div class="col-md-12">
			...
			<form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" name ="login_form">
				<div align="center">
					...
					<span class="style7">
					<label>
					  <span class="style8"><b>Store Number</b></span><br/> 
					</label>
				</div>
				<div align="center">
					...
					<span class="style7">
					<label>
					  <span class="style8"><b>Store Name</b></span><br/> 
					</label>
				</div>
				<div align="center">
