...
$post_details[] = "'".$_COOKIE['storename']."'";
...
$post_details[] = "'".$_COOKIE['storetype']."'";
        ...
        <div class="col-md-12">
			...
			<tr>
				...
				<td style="padding-right: 4%;" width="25%">
					<p style="margin: 0; padding: 0;text-align:left;width:280px;font-size:20px;"><strong><?php echo $_COOKIE['name']; ?>,</strong>
					Store <?php echo $_COOKIE["username"]; ?></p>
				</td>
					<td style="border:3px solid black;" width="25%">
					<div class="box" style="width:320px;"> 
						<div align="center" class="style9">MY <strong>PROFILE</strong> </div>
					</div>
				</td>
				<td width="40%"></td>
			</tr>
