...
function printDiv(x,y)
{
   ...
   var divToPrint=document.getElementById('p_Loading_Analysis_Store');
  newWin= window.open("");
...
$(document).ready(function() {
 ...
 $("#p_Loading_Analysis_Store").tableExport({
            ...
            "fnPreDrawCallback": function (settings, json) {
                ...
                $("input[type='checkbox']").click(function (e) {
                    ...
                    //alert("i am true");
                        ...
                        //alert(sumQty);
                        $('td:eq(17)', row).val("<input type='hidden' name='linetotal' class='linetotal' value='"+colVal+"' /> "+colVal);
...
<div class="container-fluid">
    <div class="row">
			...
			<tr>
				...
				<td style="border:3px solid black;"  width="25%">
					<div class="box" style="width:320px;"> 
						<div align="center" class="style9"> MY <strong>Distribution</strong>   </div>
					</div>
				</td>
				<td width="40%"></td>
			</tr>
      ...
      <div class="row">
				...
				<div class="col-md-1">
					<button type="submit" style="float:right" class="save btn btn-success"><b>SAVE</b></button>
				</div>	
				<div class="col-md-1 text-right">
					<a class="btn btn-danger" style="float:right" href="map.php"><b>Map</b></a>
...
<div class="container-fluid">    
    <div class="row">
        <div class="col-md-12 ">
			...
			<div class="row">
				<div class="col-md-12">
					<table id="p_Loading_Analysis_Store" class="table table-scroll table-striped responsive-table table-bordered table-inverse style7" cellspacing="0" width="100%">
							<thead class="">
							<tr class="">
...
if( $conn === false )
{
	die('mssql not connecting : ' . sqlsrv_errors());
							...
							$values_to_call = "'".$_COOKIE['storename']."','HH601','".$_COOKIE['username']."'";
							...
							while ($row = sqlsrv_fetch_array($stmt3, SQLSRV_FETCH_ASSOC)) {
								...
								echo "<tr>"; 
									...
									echo "<td width='12%'>".$row['MARKET']."</td>";
									echo "<td width='12%'>".$row['FSA']."</td>";
									echo "<td><input type='hidden' name='route_".$cnt."' value='".$row['ROUTE']."'/>".$row['ROUTE']."</td>";
									echo "<td width='12%'>".$row['DRIVEDISTANCE']."</td>";
							?>      
									<td width="12%" >
								...
								<?        
									echo "<td width='12%' ><input type='hidden' id='sel' name='aselected_".$cnt."' value='".$row['A_SELECTED']."'/>".$row['A_SELECTED']."</td>";
									echo "<td width='12%' >".$row['B_SELECTED']."</td>";
									echo "<td width='12%'><input type='hidden' name='linetotal_".$cnt."' class='linetotal' value='".$total."'/>".$total."</td>";
								echo "</tr>";   
								//print_r($row);
								/*
								for ($ii = 0; $ii <= 26; $ii ++) {
