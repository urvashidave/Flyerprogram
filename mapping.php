    ...
    <div class="row">
        <div class="col-md-12">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<button class="btn btn-warning"><b>National Program</b></button>
				</div>	
				<div class="col-md-2">
					<button class="btn btn-info"><b>Optional Program</b></button>
				</div>	
				<div class="col-md-2">
					<button class="btn btn-primary"><b>Catalogue Program</b></button>
                </div>
				<div class="col-md-1"></div>	
				<div class="col-md-2">
			...
			<table id="p_Loading_Analysis_Store" class="table table-bordered table-inverse style7" cellspacing="0">
                ...
                <tbody>
                    ...
                    $values_to_call = "'HH','HH601','1000-5'";

                    $params[] = "CLIENT_CODE";
                    $params[] = "PROJECT";
                    $params[] = "STORE";
                    $tsql_callSP = "EXEC TEST.DBO.p_Loading_Store_Market_Area  $values_to_call ";
        ...
        <div class="col-md-12">
			...
			<table id="p_Loading_Analysis_Store" class="table table-bordered table-inverse style7" cellspacing="0">
                ...
                <tbody>
                    ...
                    $values_to_call = "'PV','PV601','3201'";

                    $params[] = "CLIENT_CODE";
                    $params[] = "PROJECT";
                    $params[] = "STORE";
                    $tsql_callSP = "EXEC TEST.DBO.p_Loading_Analysis_Store  $values_to_call ";
