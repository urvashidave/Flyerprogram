			 ...
			 <table class="table table-bordered table-inverse single-border" style="width:100%"  height="129" cellpadding="2" cellspacing="1">
			  ...
			  do {
				  if ($row_Recordset2['EVENT_TYPE'] != $current_flyer){
					...
					echo '<tr><th class="flyer-type-header text-center" colspan="1000" style="border:1px solid black;">'.$flyer_types[$row_Recordset2['EVENT_TYPE']].'</th></tr>';
			  ...
			  ?>
				<tr>
				 ...
				 <span class="style7"><?php echo $row_Recordset2['EVENT_NUMBER']; ?></span></td>
				  ...
				  <td class="style7"><div align="center" class=" style12"><?php echo $row_Recordset2['CITY']; ?></div></td>
				<td class="style7"><div align="center" class=" style12"><?php echo number_format($row_Recordset2['qty'], 0); ?></div></td>
				 <td class="style7"><div align="center" class=" style12"><?php echo number_format($row_Recordset2['store_qty'], 0); ?></div></td>
				  <td class="style7"><div align="center" class=" style12"><?php echo as_dollars($row_Recordset2['TOTAL_PRINT_COST'], 2); ?></div></td>
					<td class="style7"><div align="center" class=" style12"><?php echo as_dollars($row_Recordset2['TOTAL_DISTRIBUTION_COST']); ?></div></td>
				  <td class="style7"><div align="center" class=" style12">
					<?php echo as_dollars($row_Recordset2['TOTAL_PRINT_COST'] + $row_Recordset2['TOTAL_DISTRIBUTION_COST']); ?>
				   </div></td>
				   <?php 
				...
				<?php } while ($row_Recordset2 = mysql_fetch_assoc($Recordset2)); ?>
					...
					<?php 
						...
						echo '<tr class="totals"><td></td>
							<th style="border:1px solid black;">Total Program</th><td></td><td>'.number_format($total_qty, 0).'</td>
							<td>'.number_format($total_store, 0).'</td>
							<td>'.as_dollars($total_print_cost).'</td>
							<td>'.as_dollars($total_distribution_cost).'</td>
							<td>'.as_dollars($total_cost).'</td><td colspan="1000"></td></tr>';
