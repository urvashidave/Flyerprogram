			...
			<tr>
				...
				<td style="" width="25%">
					<div class="box" style="width:320px;"> 
						<div align="center" class="style9"><strong>EDIT PROFILE</strong> </div>
					</div>
				</td>
				<td width="40%"></td>
			</tr>
        ...
        <div class="col-md-12">
			...
			$ii = 7;
					...
					echo '<tr><td><strong>DISTRIBUTION</strong></td>';
						...
						echo "<td><input type='checkbox' name='mycpc_0' id='mycpc_0' " . $temp_check . " ></td>";
						$temp_check = ""; if($bmycpc[1]>0) $temp_check = "checked='checked'";
						echo "<td><input type='checkbox' name='mycpc_1' id='mycpc_1' " . $temp_check . " ></td>";
						$temp_check = ""; if($bmycpc[4]>0) $temp_check = "checked='checked'";
						echo "<td><input type='checkbox' name='mycpc_4' id='mycpc_4' " . $temp_check . " ></td>";
						echo "<td> &nbsp;</td>";
						echo '</tr>';
						...
						echo "<td><input type='checkbox' name='mycpc_2' id='mycpc_2' " . $temp_check . " ></td>";
						$temp_check = ""; if($bmycpc[3]>0) $temp_check = "checked='checked'";
						echo "<td><input type='checkbox' name='mycpc_3' id='mycpc_3' " . $temp_check . " ></td>";
						echo "<td>N/A</td>";
						echo "<td> &nbsp;</td>";
						echo '</tr>';
						...
						echo "<td><input type='checkbox' name='mycpc_5' id='mycpc_5' " . $temp_check . " ></td>";
						$temp_check = ""; if($bmycpc[6]>0) $temp_check = "checked='checked'";
						echo "<td><input type='checkbox' name='mycpc_6' id='mycpc_6' " . $temp_check . " ></td>";
						$temp_check = ""; if($bmycpc[9]>0) $temp_check = "checked='checked'";
						echo "<td><input type='checkbox' name='mycpc_9' id='mycpc_9' " . $temp_check . " ></td>";			
						echo "<td> &nbsp;</td>";
						echo '</tr>';
						...
						echo "<td><input type='checkbox' name='mycpc_7' id='mycpc_7' " . $temp_check . " ></td>";
						$temp_check = ""; if($bmycpc[8]>0) $temp_check = "checked='checked'";
						echo "<td><input type='checkbox' name='mycpc_8' id='mycpc_8' " . $temp_check . " ></td>";			
						echo "<td>N/A</td>";
						echo "<td> &nbsp;</td>";
						echo '</tr>';
						...
						echo "<td><input type='checkbox' name='mycpc_10' id='mycpc_10' " . $temp_check . " ></td>";
						$temp_check = ""; if($bmycpc[11]>0) $temp_check = "checked='checked'";
						echo "<td><input type='checkbox' name='mycpc_11' id='mycpc_11' " . $temp_check . " ></td>";
						$temp_check = ""; if($bmycpc[14]>0) $temp_check = "checked='checked'";
						echo "<td><input type='checkbox' name='mycpc_14' id='mycpc_14' " . $temp_check . " ></td>";
						echo "<td> &nbsp;</td>";
						echo '</tr>';
						...
						echo "<td><input type='checkbox' name='mycpc_12' id='mycpc_12' " . $temp_check . " ></td>";
						$temp_check = ""; if($bmycpc[13]>0) $temp_check = "checked='checked'";
						echo "<td><input type='checkbox' name='mycpc_13' id='mycpc_13' " . $temp_check . " ></td>";
						echo "<td>N/A</td>";
						echo "<td> &nbsp;</td>";
						echo '</tr>';
